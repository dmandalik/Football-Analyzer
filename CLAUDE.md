...
- Before any real Messi fit: run the 80-realization clip-matched validation at his noise point (1.8 px cross / 19 px along, ratio 10.8). Ronaldo's validation (1.6/4.9, ratio 3) does not transfer to that regime.